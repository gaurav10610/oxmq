...
/**
 * Real-World Recipe: Rate Limiting &amp; Throttling
 * Use Case: Calling third-party APIs (OpenAI, Stripe, SendGrid) with strict rate limits (e.g. max 5 req / 2 sec).
 */
public class RateLimitingExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 2. Create Rate-Limited Worker (Max 5 requests per 2 seconds)
