...
/**
 * Real-World Showcase: Automatic Retries, Exponential Backoff &amp; Dead-Letter Queue (DLQ).
 * Handles transient downstream HTTP 503 errors and archives permanent failures.
 */
