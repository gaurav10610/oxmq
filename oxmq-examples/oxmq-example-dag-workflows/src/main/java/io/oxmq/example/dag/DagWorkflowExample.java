...
/**
 * Real-World Showcase: Multi-Stage Media Pipeline (DAG Workflow)
 * Split video -> Transcode chunks in parallel -> Merge in parent assembly task upon child completion.
 */
    ...
    public static void main(String[] args) throws Exception {
        ...
        OxmqWorker<VideoChunkPayload> chunkWorker = OxmqWorker.<VideoChunkPayload>builder()
                ...
                .processor(job -> {
                    ...
                    Thread.sleep(150); // Simulate video transcoding
